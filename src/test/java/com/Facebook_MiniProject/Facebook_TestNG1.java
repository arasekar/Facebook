...
@Test
private void znputUserNamePassword() 
	{
...
@Test(invocationCount=2,dependsOnMethods = "znputUserNamePassword")
private void multipleClick() throws InterruptedException 
	{
	Thread.sleep(5000);
...
@Test(dependsOnMethods = "multipleClick")
private void login() 
	{
